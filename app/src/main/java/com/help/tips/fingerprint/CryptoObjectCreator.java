...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            LogUtils.e("TAG", "Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    LogUtils.e("TAG", " Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            LogUtils.e("TAG", " Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            LogUtils.e("TAG", " Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
